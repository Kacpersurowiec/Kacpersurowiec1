...
class Library:
    ...
    def __str__(self):
        return f' Library {self.city} {self.street} {self.zip_code} is opened: {self.open_hours}, phone: {self.phone}'
...
class Employee:
    ...
    def __str__(self):
        ...
        f"birth: {self.birth_date}, address: {self.city}, {self.street}, {self.zip_code}, tel: {self.phone}")
...
class Book:
    ...
    def __str__(self):
        return f"Book {self.author_name} {self.author_surname},publicated: {self.publication_date} has {self.number_of_pages}pages and you can find it in {self.library}"
...
class Order:
    ...
    def __str__(self):
        ...
        return (f'Order from day {self.order_date}, Employee: {self.employee.last_name}'
...
emp_anna = Employee("Anna", "Kowalska", "2020-05-15", "1990-01-20", "Warszawa", "Słoneczna 1", "00-100", "700-100-100")
emp_piotr = Employee("Piotr", "Nowak", "2018-09-01", "1985-11-11", "Kraków", "Gwiezdna 2", "30-200", "700-200-200")
emp_ewelina = Employee("Ewelina", "Zielińska", "2022-01-10", "1995-07-07", "Warszawa", "Leśna 3", "00-300", "700-300-300")
